...
const GraphScatter = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M1 14.5C1 14.776 1.224 15 1.5 15H14.5C14.776 15 15 14.776 15 14.5C15 14.224 14.776 14 14.5 14H2V1.5C2 1.224 1.776 1 1.5 1C1.224 1 1 1.224 1 1.5V14.5Z" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
